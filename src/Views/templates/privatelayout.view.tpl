...
<body>
  <header>
    ...
    <a href="index.php?page=mnt_carrito">
      ...
      <div class="card-img-top"
        style="background-size: cover ;width:1cm;height:1cm;background-repeat: no-repeat; background-image: url('public/imgs/Caratulas/cart.png');">
      </div>
    </a>
  ...
  <footer>
    <div>Todo los Derechos Reservados 2022 GameStore &copy;</div>
  </footer>
  {{foreach EndScripts}}
  <script src="/{{~BASE_DIR}}/{{this}}"></script>
  {{endfor EndScripts}}
